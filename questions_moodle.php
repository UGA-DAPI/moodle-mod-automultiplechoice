...
//$output = $PAGE->get_renderer('mod_automultiplechoice'); //$controller->getRenderer('dashboard');
//$process = new  \mod_automultiplechoice\local\amc\process($quiz);



$viewcontext = \context_module::instance($cm->id);
//$thispageurl = new moodle_url('/mod/automultiplechoice/questions.php');
//$thispageurl->param('id', $cm->id);
//$cmid = required_param('cmid', PARAM_INT);

//$PAGE->set_url('/mod/automultiplechoice/questions.php', array('id' => $cm->id));
$cmid = $cm->id;
//$contexts = $viewcontext;
list($thispageurl, $contexts, $cmid, $cm, $quiz, $pagevars) = question_edit_setup('editq', '/mod/automultiplechoice/questions.php', true);
...
$course = $DB->get_record('course', array('id' => $quiz->course), '*', MUST_EXIST);
$quizobj = new \mod_automultiplechoice\local\models\quiz($quiz, $cm, $course);
