...
list($thispageurl, $contexts, $cmid, $cm, $quiz, $pagevars) =
        question_edit_setup('editq', '/mod/automultiplechoice/edit.php', true);
...
//require_capability('mod/automultiplechoice:manage', $contexts->lowest());
require_capability('mod/automultiplechoice:addinstance', $contexts->lowest());
