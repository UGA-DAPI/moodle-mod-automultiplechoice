...
/*
    ...
    echo '<form action="?a=' . $quiz->id .'" method="post">' . "\n";
    echo '<ul>';
    $ckcopie = ($quiz->studentaccess ? 'checked="checked"' : '');
    $ckcorrige = ($quiz->corrigeaccess ? 'checked="checked"' : '');
    ...
    echo $OUTPUT->single_button(
        new moodle_url(
            ...
            array('a' => $quiz->id, 'action' => 'notification')
        ),
