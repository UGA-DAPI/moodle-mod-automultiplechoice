...
class latex extends \mod_automultiplechoice\local\format\api
{
    ...
    public function __construct($quiz=null, $codelength=10) {
    ...
    protected function getHeader() {
        ...
        $quizzName = $this->htmlToLatex($this->quiz->name);
        ...
        $options = "lang=FR%\n"
            ...
            . ($params->shuffleq ? '%' : '') . ",noshuffle% stops the automatic shuffling of the answers for every question\n"
            . ($params->separatesheet ? '' : '%') . ",separateanswersheet\n"
      . ($params->separatesheet ? '' : '%') . ",automarks";
